...
@Component({
  selector: 'app-ct-endorsed-sign-off-list',
  templateUrl: './ct-endorsed-sign-off-list.component.html',
  styleUrls: ['./ct-endorsed-sign-off-list.component.scss'],
  providers: [TitleCasePipe],
})
export class CtEndorsedSignOffListComponent implements OnInit {
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_CrewTransferService
      .getEndorsedCrewTransferSignOffRequest(this.appService.myApp)({
