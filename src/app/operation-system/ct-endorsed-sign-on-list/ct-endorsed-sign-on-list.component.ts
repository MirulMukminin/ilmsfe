...
@Component({
  selector: 'app-ct-endorsed-sign-on-list',
  templateUrl: './ct-endorsed-sign-on-list.component.html',
  styleUrls: ['./ct-endorsed-sign-on-list.component.scss'],
  providers: [TitleCasePipe],
})
export class CtEndorsedSignOnListComponent implements OnInit {
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_CrewTransferService
      .getEndorsedCrewTransferSignOnRequest(this.appService.myApp)({
    ...
    this.model.header = [
      ...
      new TableHeaderItem({ data: 'Port Of Origin' }),
