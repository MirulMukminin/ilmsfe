...
@Component({
  selector: 'app-ct-sign-on-list',
  templateUrl: './ct-sign-on-list.component.html',
  styleUrls: ['./ct-sign-on-list.component.scss'],
  providers: [TitleCasePipe],
})
export class CtSignOnListComponent implements OnInit {
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_CrewTransferService
      .getAllCrewTransferSignOnRequest(this.appService.myApp)({
