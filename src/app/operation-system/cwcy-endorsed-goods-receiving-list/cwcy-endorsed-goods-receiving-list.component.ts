...
@Component({
  selector: 'app-cwcy-endorsed-goods-receiving-list',
  templateUrl: './cwcy-endorsed-goods-receiving-list.component.html',
  styleUrls: ['./cwcy-endorsed-goods-receiving-list.component.scss'],
  providers: [TitleCasePipe],
})
export class CwcyEndorsedGoodsReceivingListComponent implements OnInit {
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_CommonWarehouseCommonYardService
      .getAllEndorsedStorageRequestByCustomer(this.appService.myApp)({
