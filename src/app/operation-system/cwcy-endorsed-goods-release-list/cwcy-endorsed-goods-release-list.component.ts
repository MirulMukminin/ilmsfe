...
@Component({
  selector: 'app-cwcy-endorsed-goods-release-list',
  templateUrl: './cwcy-endorsed-goods-release-list.component.html',
  styleUrls: ['./cwcy-endorsed-goods-release-list.component.scss'],
  providers: [TitleCasePipe],
})
export class CwcyEndorsedGoodsReleaseListComponent implements OnInit {
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_CommonWarehouseCommonYardService
      .getAllEndorsedReleaseRequestByCustomer(this.appService.myApp)({
  ...
  apiRespValidation(value: any) {
    ...
    this.date_service = value.releaseDate
      ? formatDate(value.releaseDate, 'dd/MM/yyyy', 'en_US')
      : 'N/A';
