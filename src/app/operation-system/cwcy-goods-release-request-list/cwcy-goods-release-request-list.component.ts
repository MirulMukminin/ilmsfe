...
@Component({
  selector: 'app-cwcy-goods-release-request-list',
  templateUrl: './cwcy-goods-release-request-list.component.html',
  styleUrls: ['./cwcy-goods-release-request-list.component.scss'],
  providers: [TitleCasePipe],
})
export class CwcyGoodsReleaseRequestListComponent implements OnInit {
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_CommonWarehouseCommonYardService
      .getAllReleaseRequestByCustomer(this.appService.myApp)({
