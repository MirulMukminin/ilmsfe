...
@Component({
  selector: 'app-goods-recieving-endorsed-view',
  templateUrl: './goods-recieving-endorsed-view.component.html',
  styleUrls: ['./goods-recieving-endorsed-view.component.scss'],
  providers: [TitleCasePipe],
})
export class GoodsRecievingEndorsedViewComponent implements OnInit {
  open = false;
  openEndorsed = false;
