...
@Component({
  selector: 'app-goods-recieving-list',
  templateUrl: './goods-recieving-list.component.html',
  styleUrls: ['./goods-recieving-list.component.scss'],
})
export class GoodsRecievingListComponent implements OnInit {
