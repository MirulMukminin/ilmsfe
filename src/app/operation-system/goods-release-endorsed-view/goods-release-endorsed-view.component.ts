...
@Component({
  selector: 'app-goods-release-endorsed-view',
  templateUrl: './goods-release-endorsed-view.component.html',
  styleUrls: ['./goods-release-endorsed-view.component.scss']
})
export class GoodsReleaseEndorsedViewComponent implements OnInit {
  open = false;
  openEndorsed = false;
