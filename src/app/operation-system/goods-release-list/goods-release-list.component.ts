...
@Component({
  selector: 'app-goods-release-list',
  templateUrl: './goods-release-list.component.html',
  styleUrls: ['./goods-release-list.component.scss']
})
export class GoodsReleaseListComponent implements OnInit {
