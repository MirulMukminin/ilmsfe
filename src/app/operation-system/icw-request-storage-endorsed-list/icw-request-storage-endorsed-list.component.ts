...
@Component({
  selector: 'app-icw-request-storage-endorsed-list',
  templateUrl: './icw-request-storage-endorsed-list.component.html',
  styleUrls: ['./icw-request-storage-endorsed-list.component.scss'],
  providers: [TitleCasePipe],
})
export class IcwRequestStorageEndorsedListComponent implements OnInit {
