...
@Component({
  selector: 'app-icw-request-storage-endorsed-view',
  templateUrl: './icw-request-storage-endorsed-view.component.html',
  styleUrls: ['./icw-request-storage-endorsed-view.component.scss'],
  providers: [TitleCasePipe],
})
export class IcwRequestStorageEndorsedViewComponent implements OnInit {
  open = false;
  openEndorsed = false;
  ...
  */
  private getRestServiceAPI(customer: string) {
    ...
    restServices.pbksb_ICWRestService
      ...
      .getEndorsedStorageRequestsByCustomer(this.appService.myApp)(param)
      .then((result) => {
  ...
  onCancel() {
    ...
    const params = {
      form: {
        ...
        cancelecanceledByUserNamedBy: this.name,
      },
    };
    ...
    restServices.pbksb_ICWRestService
      ...
      .then((result) => {
        ...
        this.router.navigate([
          '/operation-system/icw-request-storage-enorsed-list',
        ]);
      });
  }
