...
@Component({
  selector: 'app-icw-transfer-endorsed-list',
  templateUrl: './icw-transfer-endorsed-list.component.html',
  styleUrls: ['./icw-transfer-endorsed-list.component.scss'],
  providers: [TitleCasePipe],
})
export class IcwTransferEndorsedListComponent implements OnInit {
