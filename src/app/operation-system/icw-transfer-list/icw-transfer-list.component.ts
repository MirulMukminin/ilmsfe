...
@Component({
  selector: 'app-icw-transfer-list',
  templateUrl: './icw-transfer-list.component.html',
  styleUrls: ['./icw-transfer-list.component.scss'],
  providers: [TitleCasePipe],
})
export class IcwTransferListComponent implements OnInit {
