...
@Component({
  selector: 'app-icw-transfer-view',
  templateUrl: './icw-transfer-view.component.html',
  styleUrls: ['./icw-transfer-view.component.scss'],
  providers: [TitleCasePipe],
})
export class IcwTransferViewComponent implements OnInit {
  open = false;
  openEndorsed = false;
  ...
  private getRestServiceAPI(customer: string) {
    ...
    restServices.pbksb_ICWTransferRestService
       ...
       */
        ...
        this.status = this.detailRequestStorage.status.replaceAll('_',' ');
  ...
  */
  ...
  onCancel() {
    ...
    restServices.pbksb_ICWTransferRestService
      .cancelTransferRequest(this.appService.myApp)(params)
      .then(() => {
        this.date = new Date();
        this.router
