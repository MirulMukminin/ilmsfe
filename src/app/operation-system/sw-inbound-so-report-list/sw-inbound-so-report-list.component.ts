...
@Component({
  selector: 'app-sw-inbound-so-report-list',
  templateUrl: './sw-inbound-so-report-list.component.html',
  styleUrls: ['./sw-inbound-so-report-list.component.scss'],
  providers: [TitleCasePipe],
})
export class SwInboundSoReportListComponent implements OnInit {
  ...
  inboundServiceList = [
    // {
    //   formNo: 'IB5012548882',
    //   orderNo: 'SW5012548882',
    //   date_received: '09/10/2021 08:00',
    //   expiry_date: '09/10/2021',
    //   status: 'Pending Endorsement',
    // },
    // {
    //   formNo: 'IB5012548854',
    //   orderNo: 'SW5012548854',
    //   date_received: '09/10/2021 08:00',
    //   expiry_date: '09/10/2021',
    //   status: 'Endorsed',
    // },
  ...
  getRestServicesAPI(company: string) {
    ...
    restServices.pbksb_ScheduledWasteService
      .getInboundSOReportList(this.appService.myApp)(params)
      .then((result) => {
        let resultArr = this.appService.jsonToArray(result);
        this.inboundServiceList = resultArr;
        this.inboundServiceList.sort((a, b) => {
          return b.scheduledWaste.jobNo.localeCompare(
            a.scheduledWaste.jobNo,
            'en',
            {
              numeric: true,
            }
  ...
  apiRespValidation(value: any) {
    ...
    this.orderNo = value.scheduledWaste ? value.scheduledWaste.jobNo : 'N/A';
